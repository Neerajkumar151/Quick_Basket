      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-description text-muted-foreground">{t("common.goTo", "Go to:")}</span>
            <input
              type="number"
              min={1}
              max={totalPages}
              ...
              placeholder="Pg"
              className="w-14 rounded-md border border-border bg-transparent px-2 py-1.5 text-description focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
            />
          </div>
        </div>
      </div>
