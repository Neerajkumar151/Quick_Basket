  ...
  return (
    <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="w-full h-32 md:h-48 bg-muted relative">
        {profile.bannerUrl ? (
          <img src={resolveImageUrl(profile.bannerUrl)} alt="Store Banner" className="w-full h-full object-cover transition-opacity duration-300" loading="lazy" decoding="async" />
        ) : (
      ...
      <div className="p-6 pt-0 flex flex-col md:flex-row items-start md:items-end justify-between gap-4 relative">
        <div className="flex items-end gap-4 w-full">
          ...
          <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-card border-4 border-card shadow-sm flex items-center justify-center overflow-hidden shrink-0 relative z-10 -mt-10 md:-mt-12">
            {profile.logoUrl ? (
              <img src={resolveImageUrl(profile.logoUrl)} alt="Store Logo" className="w-full h-full object-cover bg-muted transition-opacity duration-300" loading="lazy" decoding="async" />
            ) : (
